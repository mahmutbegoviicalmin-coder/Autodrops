      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
        <div className="bg-gray-900/60 border border-gray-700/60 rounded-2xl p-6 lg:p-10 card-gradient relative overflow-hidden">
          ...
          <div className="prose lg:prose-lg dark:prose-invert max-w-none prose-headings:text-white prose-a:text-blue-400">
            <p className="mb-6">
              Welcome to AutoDrops ("we", "our", "us"). These Terms of Use ("Terms") govern your access to and use of our website autodrops.io (the "Site") and related services (the "Services"). By accessing or using AutoDrops, you agree to be bound by these Terms. If you do not agree, you may not use our Services.
            </p>

            <h2 className="text-xl font-semibold mt-8 mb-4">1. Eligibility</h2>
            <p className="mb-6">
              You must be at least 18 years old or the age of majority in your jurisdiction to use AutoDrops. By using our Services, you represent and warrant that you meet these requirements.
            </p>

            <h2 className="text-xl font-semibold mt-8 mb-4">2. Services</h2>
            <p className="mb-6">
              AutoDrops provides an AI-powered platform that helps users discover, analyze, and import winning products into their online stores (e.g., Shopify, WooCommerce). The Services are provided "as is" and may be updated, modified, or discontinued at any time without notice.
            </p>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li>AutoDrops is not liable for unauthorized access resulting from your failure to secure your account.</li>
            </ul>

            <h2 className="text-xl font-semibold mt-8 mb-4">4. Subscription and Payment</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>Some features of AutoDrops require a paid subscription.</li>
              <li>By subscribing, you agree to pay all applicable fees as described on autodrops.io.</li>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li>Circumvent or attempt to bypass system limitations (e.g., API request limits).</li>
              <li>Resell, copy, or redistribute our platform or data without permission.</li>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li>Fail to pay applicable fees, or</li>
